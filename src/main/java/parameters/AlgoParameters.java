...
public class AlgoParameters {
	...
	private float DISTANCE_FROM_PEPTIDE_TO_WHICH_INTERACTINGPROTEIN_IS_CONSIDERED = 5.5f;
	...
	private float DISTANCE_FROM_PEPTIDE_TO_WHICH_INTERACTINGPROTEIN_IS_SHORTENED = 4.5f;
	...
	private float FRACTION_NEEDED_ON_HIT = 0.65f; // 0.65f;
	private int COUNT_OF_RESIDUES_IGNORED_IN_SHAPE_BUILDING_BEFORE_AND_AFTER_PEPTIDE = 4;
	...
	public float getFRACTION_NEEDED_ON_HIT() {
		return FRACTION_NEEDED_ON_HIT;
	}
	public void setFRACTION_NEEDED_ON_HIT(float fRACTION_NEEDED_ON_HIT) {
		FRACTION_NEEDED_ON_HIT = fRACTION_NEEDED_ON_HIT;
	}
