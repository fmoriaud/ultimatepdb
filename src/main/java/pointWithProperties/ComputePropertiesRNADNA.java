...
public class ComputePropertiesRNADNA implements ComputePropertiesIfc {
    ...
    // Constructor
    // -------------------------------------------------------------------
    public ComputePropertiesRNADNA(MyStructureIfc structure, AlgoParameters algoParameters, List<HBondDefinedWithAtoms> dehydrons, List<PointIfc> listOfLigandPoints) {
