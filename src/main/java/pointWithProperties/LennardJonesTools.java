...
public class LennardJonesTools {
    ...
    private static LennarJonesGromacs getLennardJonesByFirstLetterInAtomName(String atomName) {
        ...
        switch (firstLetter) {
            // TODO make it better
            case "C":
                return LennarJonesGromacs.alj_C; // sp2 C carbonyl group
            case "N":
                return LennarJonesGromacs.alj_N; // sp2 nitrogen in amide groups
            case "O":
                return LennarJonesGromacs.alj_O; // carbonyl group oxygen
            case "P":
                return LennarJonesGromacs.alj_P; //
            case "S":
                return LennarJonesGromacs.alj_S; //
            case "I":
                return LennarJonesGromacs.alj_I; //
            case "F":
                return LennarJonesGromacs.alj_F; //
    ...
    private static LennarJonesGromacs getLennardJonesAtomTypeFromPDBAtomName(String atomName, String residueName) {
        ...
        switch (atomName) {
            ...
            case "OP1": {
                return LennarJonesGromacs.alj_OH; // sulphur in cystine
            }
            ...
            case "O4'": {
                return LennarJonesGromacs.alj_O; // sulphur in cystine
            }
            ...
            case "P": {
                ...
                if (residueName.equals("DG")) {
                    return LennarJonesGromacs.alj_P; // sulphur in cystine
                }
                if (residueName.equals("DC")) {
                    return LennarJonesGromacs.alj_P; // sulphur in cystine
                }
                if (residueName.equals("DA")) {
                    return LennarJonesGromacs.alj_P; // sulphur in cystine
                }
                if (residueName.equals("DI")) {
                    return LennarJonesGromacs.alj_P; // sulphur in cystine
                }
                if (residueName.equals("DT")) {
                    return LennarJonesGromacs.alj_P; // sulphur in cystine
                }
                if (residueName.equals("G")) {
                    return LennarJonesGromacs.alj_P; // sulphur in cystine
                }
                if (residueName.equals("C")) {
                    return LennarJonesGromacs.alj_P; // sulphur in cystine
                }
                if (residueName.equals("A")) {
                    return LennarJonesGromacs.alj_P; // sulphur in cystine
                }
                if (residueName.equals("U")) {
                    return LennarJonesGromacs.alj_P; // sulphur in cystine
                }
                if (residueName.equals("I")) {
                    return LennarJonesGromacs.alj_P; // sulphur in cystine
                }
                return null;
            }
            ...
            case "N4": {
                return LennarJonesGromacs.alj_N;
            }
            ...
            case "C4": {
                return LennarJonesGromacs.alj_C;
            }
