...
public class ShapeContainer implements ShapeContainerIfc{ // in case it is used it is ready to be
	...
	// Constructor
	// -------------------------------------------------------------------
	public ShapeContainer(CollectionOfPointsWithPropertiesIfc shape, List<PointIfc> listPointDefininingLigandUsedToComputeShape, MyStructureIfc myStructureUsedToComputeShape, AlgoParameters algoParameters){
		this.shape = shape;
