...
public class Minimize {
	...
	// Constructor
	// -------------------------------------------------------------------
	public Minimize(UltiJMol ultiJMol, String selectCommandOfWhatToFix, AlgoParameters algoParameters){
	...
	public boolean compute() throws InterruptedException, ExceptionInScoringUsingBioJavaJMolGUI{
		...
		ultiJMol.jmolviewerForUlti.evalString("minimize FIX {" + selectCommandOfWhatToFix + "} select {*}\n");
