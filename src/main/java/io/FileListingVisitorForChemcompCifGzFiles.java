...
/**
 * Created by Fabrice on 28/10/16.
 */
public class FileListingVisitorForChemcompCifGzFiles {
    ...
    // Constructor
    // -------------------------------------------------------------------
    public FileListingVisitorForChemcompCifGzFiles(String path) throws IOException {

        FileVisitor<Path> fileProcessor = new FileListingVisitorForChemcompCifGzFiles.ProcessFile();
