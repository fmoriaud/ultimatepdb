...
public class EquidistributionPhi {
   ...
   public Map<Integer, List<Double>> getMapCountOfIntervalsAndPointValues() {
    ...
    public static void main(String[] args) {
        ...
        // Output each time there is a new minimum found.
        // Just wait for the end of the computation to take the final values and create a new list in this class
        optimizeDeltasN28(startingValues, startingDeltaValues, n);
    }
    ...
    // Implementation
    // -------------------------------------------------------------------
    private static List<Double> defineStartingDeltaValues(Integer n) {
    ...
    private static List<Double> defineStartingValues(Integer n) {
    ...
    private static void optimizeDeltasN6(List<Double> startingValues, List<Double> startingDeltaValues, Integer n) {
    ...
    private static void optimizeDeltasN8(List<Double> startingValues, List<Double> startingDeltaValues, Integer n) {
    ...
    private static void optimizeDeltasN10(List<Double> startingValues, List<Double> startingDeltaValues, Integer n) {
    ...
    private static void optimizeDeltasN12(List<Double> startingValues, List<Double> startingDeltaValues, Integer n) {
    ...
    private static void optimizeDeltasN14(List<Double> startingValues, List<Double> startingDeltaValues, Integer n) {
    ...
    private static void optimizeDeltasN16(List<Double> startingValues, List<Double> startingDeltaValues, Integer n) {
    ...
    private static void optimizeDeltasN18(List<Double> startingValues, List<Double> startingDeltaValues, Integer n) {
    ...
    private static void optimizeDeltasN20(List<Double> startingValues, List<Double> startingDeltaValues, Integer n) {
    ...
    private static void optimizeDeltasN22(List<Double> startingValues, List<Double> startingDeltaValues, Integer n) {
    ...
    private static void optimizeDeltasN24(List<Double> startingValues, List<Double> startingDeltaValues, Integer n) {
    ...
    private static void optimizeDeltasN26(List<Double> startingValues, List<Double> startingDeltaValues, Integer n) {
    ...
    private static void optimizeDeltasN28(List<Double> startingValues, List<Double> startingDeltaValues, Integer n) {
