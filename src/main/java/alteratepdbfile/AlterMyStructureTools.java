...
public class AlterMyStructureTools {
	...
	private static MyMonomerIfc convertMyMonomer(MyMonomerIfc inputMonomer, char[] newResidue3LetterCode,
		...
		try {
			newMyMonomer = new MyMonomer(myAtoms, newResidue3LetterCode, inputMonomer.getResidueID(), MyMonomerType.getEnumType(inputMonomer.getType()), inputMonomer.isWasHetatm(), inputMonomer.getInsertionLetter(), inputMonomer.getAltLocGroup());
